...
屏幕使用的是反客的一体化7寸屏，已经将驱动电路包含在内，不考虑底层硬件逻辑，直接使用单片机输出的LTDC即可控制该屏幕显示触摸，硬件组成如下：后续配置参考反客提供的原理图和[H750数据手册（规格书）](https://www.st.com.cn/resource/en/datasheet/stm32h750ib.pdf)
